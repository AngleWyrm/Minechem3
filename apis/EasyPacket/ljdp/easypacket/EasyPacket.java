...
/**
 * Packets must subclass this.
 * You must have a constructor with no arguments.
 * You can have other constructors too.
 * @author lukeperkin
 */
public abstract class EasyPacket {
	
	/**
	 * This constructor is needed so that an EasyPacketHandler
	 * can create an empty packet.
	 */
	public EasyPacket() {

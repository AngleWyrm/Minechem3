...
public class MinechemRecipes {
	...
	public void RegisterRecipes() {
		...
		DecomposerRecipe.add(new DecomposerRecipe(obsidian, molecule(siliconDioxide,16), molecule(magnesiumOxide,8)));
		SynthesisRecipe.add(new SynthesisRecipe(obsidian, true, 1000,
				...
				molecule(siliconDioxide,4), null,		molecule(magnesiumOxide,2),
	...
	public void oreEvent(OreRegisterEvent event) {
	   ...
	   else if(event.Name.contains("ingotAdamantine")){
	   ...
	   SynthesisRecipe.add(new SynthesisRecipe(event.Ore, false, 780, new Molecule(water, 6), new Element(Cn, 1), new Element(Co, 1), new Element(Br, 2), new Element(O, 6) ));
			...
			else if(event.Name.contains("ingotAdluorite")) {
			...
			else if(event.Name.contains("ingotAmordrine")) {
			...
			else if(event.Name.contains("ingotAngmallen")) {
			...
			else if(event.Name.contains("ingotAredrite")) {
			...
			else if(event.Name.contains("ingotAstral Silver")) {
			...
			else if(event.Name.contains("ingotAtlarus")) {
			...
			else if(event.Name.contains("ingotBlack Steel")) {
			...
			else if(event.Name.contains("ingotCarmot")) {
			...
			else if(event.Name.contains("ingotCelenegil")) {
			...
			else if(event.Name.contains("ingotCeruclase")) {
			...
			else if(event.Name.contains("ingotDamascus Steel")) {
			...
			else if(event.Name.contains("ingotDeep Iron")) {
			...
			else if(event.Name.contains("ingotDesichalkos")) {
			...
			else if(event.Name.contains("ingotEximite")) {
			...
			else if(event.Name.contains("ingotHaderoth")) {
			...
			else if(event.Name.contains("ingotHepatizon")) {
			...
			else if(event.Name.contains("ingotIgnatius")) {
			...
			else if(event.Name.contains("ingotInfuscolium")) {
			...
			else if(event.Name.contains("ingotInolashite")) {
			...
			else if(event.Name.contains("ingotKalendrite")) {
			...
			else if(event.Name.contains("ingotLemurite")) {
			...
			else if(event.Name.contains("ingotMeutoite")) {
			...
			else if(event.Name.contains("ingotMidasium")) {
			...
			else if(event.Name.contains("ingotMithril")) {
			...
			else if(event.Name.contains("ingotOrichalcum")) {
			...
			else if(event.Name.contains("ingotOureclase")) {
			...
			else if(event.Name.contains("ingotPrometheum")) {
			...
			else if(event.Name.contains("ingotRubracium")) {
			...
			else if(event.Name.contains("ingotSanguinite")) {
			...
			else if(event.Name.contains("ingotShadow Iron")) {
			...
			else if(event.Name.contains("ingotShadow Steel")) {
			...
			else if(event.Name.contains("ingotTartarite")) {
			...
			else if(event.Name.contains("ingotVulcanite")) {
			...
			else if(event.Name.contains("ingotVyroxeres")) {
